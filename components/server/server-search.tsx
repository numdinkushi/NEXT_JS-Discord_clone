...
const ServerSearch = ({
  ...
  return (
    <>
      <button onClick={() => setOpen(true)} className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full bg-zinc-700/10 dark:bg-zinc-600/50 hover:bg-zinc-600/10 dark:hover:bg-zinc-700/50 transition">
        <Search className="w-4 text-zinc-500 dark:text-zinc-400" />
