...
export const ServerHeader = ({
    ...
    return (
        <DropdownMenu>
            ...
            >
                <button
                    className="w-full text-md font-semibold px-3 flex items-center h-12 border-neutral-200 dark:border-neutral-800 border-b-2 hover:bg-zinc-700/10 dark:hover:bg-zinc-500/50 transition"
                >
                    {server.name}
